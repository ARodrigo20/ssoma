...
{
    public class GetJerarquiaAllQuery : IRequest<JerarquiaVM>
    {

        public class GetJerarquiaAllQueryHandler : IRequestHandler<GetJerarquiaAllQuery, JerarquiaVM>
        {
            private readonly IApplicationDbContext _context;
            private readonly IMapper _mapper;
            public IConfiguration Configuration { get; }
            public GetJerarquiaAllQueryHandler(IApplicationDbContext context, IMapper mapper, IConfiguration configuration)
            {
                _context = context;
                _mapper = mapper;
                Configuration = configuration;
            }
            public async Task<JerarquiaVM> Handle(GetJerarquiaAllQuery request, CancellationToken cancellationToken)
            {
