...
namespace Hsec.Application.PlanAccion.Commands.UpdatePlanDeAccion2
{
    public partial class UpdatePlanAccionCommand : IRequest<Unit>
    {
        ...
        public IList<PlanUpdateVM> planes { get; set; }
        ...
        public class UpdatePlanAccionCommandHandler : IRequestHandler<UpdatePlanAccionCommand, Unit>
        {
            ...
            {
                IList<PlanUpdateVM> planesAccion = new List<PlanUpdateVM>();
                ...
                IList<ResposablesDtoUpdate> respJson;
                ...
                foreach (var accionJson in planesAccion)
                {
                    ...
                    if (dataBD != null)
                    {
                        ...
                        respJson = new List<ResposablesDtoUpdate>();
