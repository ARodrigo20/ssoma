...
namespace Hsec.Application.Observacion.Commands.UpdateObservacion {
    internal class VerificacionControlCriticoSubHandle : Strategia {
        public string _VCCCod { get; set; }
        private readonly string RESPUESTA_INCORRECTA = "R002";

        public VerificacionControlCriticoSubHandle(IApplicationDbContext context, IMapper mapper) : base(context, mapper) { }
        ...
        public override void CreateDetalleSubTipo(ObservacionDto dataObs)
        {
            ...
            ICollection<string> herramientas = dataObs.VerificacionControlCritico.Herramientas;
            ...
            ICollection<CriterioDto> Criterios = dataObs.VerificacionControlCritico.Criterios;
            ...
            foreach (var item in ControlCritico)
            {
                ...
                data.CodCC = item;
                data.CodVcc = _VCCCod;
                data.CodCartilla = dataObs.VerificacionControlCritico.CodCartilla;
            ...
            ICollection<CierreInteraccionDto> CierreInteraccion = dataObs.VerificacionControlCritico.CierreInteracion;
        ...
        public string nextCodVCC()
        {
            ...
            */
            ...
            else
            {
                ...
                COD_INCIDENTE_MAX = String.Format("OBV{0,8:0000000000}", max);
            }
