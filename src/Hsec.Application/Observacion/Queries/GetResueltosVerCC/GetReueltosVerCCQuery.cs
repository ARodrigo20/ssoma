...
{
    public class GetReueltosVerCCQuery : IRequest<ResueltosVM>
    {
        public string CodPersona { get; set; }
        public string Anio { get; set; }
        public string CodMes { get; set; }
        public class GetReueltosVerCCQueryHandler : IRequestHandler<GetReueltosVerCCQuery, ResueltosVM>
        {
            private readonly IApplicationDbContext _context;
            private readonly IMapper _mapper;
            private readonly IMediator _mediator;
            private readonly string COVID19_ID = "CCPF0000022";
            public GetReueltosVerCCQueryHandler(IApplicationDbContext context, IMapper mapper, IMediator mediator)
            {
                _context = context;
                _mapper = mapper;
                _mediator = mediator;
            ...
            public async Task<ResueltosVM> Handle(GetReueltosVerCCQuery request, CancellationToken cancellationToken)
            {
