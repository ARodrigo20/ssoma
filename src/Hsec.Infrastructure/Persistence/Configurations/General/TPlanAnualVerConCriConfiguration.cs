...
{
    public class TPlanAnualVerConCriConfiguration : IEntityTypeConfiguration<TPlanAnualVerConCri>
    {
        public void Configure(EntityTypeBuilder<TPlanAnualVerConCri> builder)
        {
