...
{
    public class TPlanAnualGeneralConfiguration : IEntityTypeConfiguration<TPlanAnualGeneral>
    {
        public void Configure(EntityTypeBuilder<TPlanAnualGeneral> builder)
        {
